 ...
 */
public class AddScanActivity extends BaseTitleBarActivity implements CaptureCallback {
...
//        String code=mDecoder.decode(bitmap);
        ...
        if (!TextUtils.isEmpty(code)) {
            ...
            if (!"score".equals(strings[0])) {
                ...
                startActivity(new Intent(this, EnterScoreActivity.class).putExtra("scoreQrcode", code));
            }
        } else {
            ToastUtil.showToast("药品二维码描中...");
        }
    }
